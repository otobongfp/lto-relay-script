...
export { Transaction, Anchor, Association, RevokeAssociation, Data, Lease, CancelLease, MassTransfer, Register, Sponsorship, CancelSponsorship, Transfer, Burn, MappedAnchor, Statement, };
export function txFromData(data) {
    switch (data.type) {
        case 4:
