import { bytesToInt, int16ToBytes, int32ToBytes } from './bytes.js';
export function booleanToBytes(input) {
...
export function integerToByteArray(input) {
    if (typeof input !== 'number')
        throw new Error('Numeric input is expected');
    return int32ToBytes(input);
}
export function bytesToByteArrayWithSize(input, lengthField = 'int16') {
...
export function byteArrayWithSizeToBytes(input, lengthField = 'int16') {
...
export function byteArrayToLong(input) {
    if (!(input instanceof Uint8Array))
        throw new Error('Uint8Array input is expected');
    let result = 0;
...
export function stringToByteArray(input) {
    if (typeof input !== 'string')
        throw new Error('String input is expected');
    return new TextEncoder().encode(input);
}
export function stringToByteArrayWithSize(input, lengthField = 'int16') {
    if (typeof input !== 'string')
        throw new Error('String input is expected');
