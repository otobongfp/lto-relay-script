...
class CancelLease extends Transaction_1.default {
    constructor(leaseId) {
        super(CancelLease.TYPE, DEFAULT_VERSION, DEFAULT_FEE);
        this.leaseId = leaseId;
    }
    toBinaryV2() {
        return (0, utils_1.concatBytes)(Uint8Array.from([this.type, this.version]), convert.stringToByteArray(this.networkId), base_1.base58.decode(this.senderPublicKey), convert.longToByteArray(this.fee), convert.longToByteArray(this.timestamp), Uint8Array.from(base_1.base58.decode(this.leaseId)));
    }
    toBinaryV3() {
        return (0, utils_1.concatBytes)(Uint8Array.from([this.type, this.version]), convert.stringToByteArray(this.networkId), convert.longToByteArray(this.timestamp), Uint8Array.from([(0, crypto_1.keyTypeId)(this.senderKeyType)]), base_1.base58.decode(this.senderPublicKey), convert.longToByteArray(this.fee), Uint8Array.from(base_1.base58.decode(this.leaseId)));
    }
    toBinary() {
        if (!this.sender)
